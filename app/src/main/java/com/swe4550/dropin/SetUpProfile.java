...
public class SetUpProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        interest_two.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //these if statements will check the game slots 1-4 to see if the said game is already in it and if it is it'll remove it.
                if (user_info.getGame1().equals("Art")) {
                    user_info.setGame1(" ");
                    Toast.makeText(SetUpProfile.this,"Art has been removed from game One spot.", Toast.LENGTH_LONG).show();
                }else if (user_info.getGame2().equals("Art")){
                    user_info.setGame2(" ");
                    Toast.makeText(SetUpProfile.this,"Art has been removed from game two spot.", Toast.LENGTH_LONG).show();
                }else if (user_info.getGame3().equals("Art")){
                    user_info.setGame3(" ");
                    Toast.makeText(SetUpProfile.this,"Art has been removed from game three spot.", Toast.LENGTH_LONG).show();
                }else if (user_info.getGame4().equals("Art")){
                    user_info.setGame4(" ");
                    Toast.makeText(SetUpProfile.this,"Art has been removed from game four spot.", Toast.LENGTH_LONG).show();
                }else if (user_info.getGame1().equals(" ")){
                    if (!user_info.getGame2().equals("Art") && !user_info.getGame3().equals("Art") && !user_info.getGame4().equals("Art")) {
                        user_info.setGame1("Art");
                        Toast.makeText(SetUpProfile.this, "Art has been added to game one spot.", Toast.LENGTH_LONG).show();
                    }
                }else if (user_info.getGame2().equals(" ")){
                    if (!user_info.getGame1().equals("Art") && !user_info.getGame3().equals("Art") && !user_info.getGame4().equals("Art")) {
                        user_info.setGame2("Art");
                        Toast.makeText(SetUpProfile.this, "Art has been added to game two spot.", Toast.LENGTH_LONG).show();
                    }
                }else if (user_info.getGame3().equals(" ")) {
                    if (!user_info.getGame1().equals("Art") && !user_info.getGame2().equals("Art") && !user_info.getGame4().equals("Art")) {
                        user_info.setGame3("Art");
                        Toast.makeText(SetUpProfile.this, "Art has been added to game three spot.", Toast.LENGTH_LONG).show();
                    }
                }else if (user_info.getGame4().equals(" ")){
                    if (!user_info.getGame1().equals("Art") && !user_info.getGame2().equals("Art") && !user_info.getGame3().equals("Art")) {
                        user_info.setGame4("Art");
                        Toast.makeText(SetUpProfile.this, "Art has been added to game four spot.", Toast.LENGTH_LONG).show();
                    }
                }else{
                    Toast.makeText(SetUpProfile.this,"All slots are filled, please uncheck another interest to add this interest.", Toast.LENGTH_LONG).show();
                }
